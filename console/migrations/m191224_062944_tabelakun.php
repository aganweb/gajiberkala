...
/**
 * Class m191224_062944_tabelakun
 */
class m191224_062944_tabelakun extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        //akun 1
        $this->createTable('{{%tb_akun1}}', [
            'kd_akun1' => $this->string(20)->notNull(),
            'akun1' => $this->string(50)
        ], $tableOptions);

        $this->addPrimaryKey('tb_akun1_pkey', 'tb_akun1', ['kd_akun1']);
        
        //akun 2
        $this->createTable('{{%tb_akun2}}', [
            'kd_akun1' => $this->string(20)->notNull(),
            'kd_akun2' => $this->string(20)->notNull(),
            'akun2' => $this->string(50)
        ], $tableOptions);
        $this->addPrimaryKey('tb_akun2_pkey', 'tb_akun2', ['kd_akun1', 'kd_akun2']);
        
        //akun 3
        $this->createTable('{{%tb_akun3}}', [
            'kd_akun1' =>$this->string(20)->notNull(),
            'kd_akun2' => $this->string(20)->notNull(),
            'kd_akun3' => $this->string(20)->notNull(),
            'akun3' => $this->string(50)
        ], $tableOptions);
        $this->addPrimaryKey('tb_akun3_pkey', 'tb_akun3', ['kd_akun1', 'kd_akun2', 'kd_akun3']);
    ...
    {
        echo "m191224_062944_tabelakun cannot be reverted.\n";
